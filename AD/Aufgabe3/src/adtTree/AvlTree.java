...
//			System.out.println("Rechter Sohn: "+wurzel.rSohn.getKey());
	...
	public static void main(String[] args){
		...
		adtTree.generate.GeneratorUnique.sortnumLeft(100);
		AdtArray arr = adtTree.generate.Generator.importNums("zahlen.dat");
...
//		tree.preOrder();
		tree.print("graph");
//		tree.delete(30);
		System.out.println("Wurzel = "+tree.high());
		
		
//		Knoten x = tree.search(30);
//		System.out.println("vater von 40 = "+x.vater);
//		tree.print("graph");
//		tree.delete(50);
		
//		tree.print("graph");
//		System.out.println(k.getHoehe());
//		System.out.println(k.vater.getKey());
	}
