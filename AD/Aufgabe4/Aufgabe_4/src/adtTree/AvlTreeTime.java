...
//			//System.out.println("Rechter Sohn: "+wurzel.rSohn.getKey());
	...
	public static void avlTreeTimeTest(AdtArray array, AvlTreeTime tree){
		long x = 0;
		for(int i = 0; i<=array.length(); i++){
			x = x +tree.insert(array.get(i));
		}
		
		long[] testErgTime = new long[1];
		testErgTime[0] = x;
						
		exportArray("AvlTree", "Time", array.length(), testErgTime);
