...
//		AdtArray arr100000 = adt.implementations.AdtContainerFactory.adtArray();
		...
		Generator.sortnumLeft(100);
		AdtArray leftarr100 = adtTree.generate.Generator.importNums("zahlen.dat");
		Generator.sortnumLeft(1000);
		AdtArray leftarr1000 = adtTree.generate.Generator.importNums("zahlen.dat");
		Generator.sortnumLeft(10000);
		AdtArray leftarr10000 = adtTree.generate.Generator.importNums("zahlen.dat");
//		AdtArray leftarr100000 = adtTree.generate.Generator.importNums("sortnumleft100000.dat");
		
		Generator.sortnumRight(100);
		AdtArray rightarr100 = adtTree.generate.Generator.importNums("zahlen.dat");
		Generator.sortnumRight(1000);
		AdtArray rightarr1000 = adtTree.generate.Generator.importNums("zahlen.dat");
		Generator.sortnumRight(10000);
		AdtArray rightarr10000 = adtTree.generate.Generator.importNums("zahlen.dat");
//		AdtArray rightarr100000 = adtTree.generate.Generator.importNums("sortnumright100000.dat");
		...
		long x = 0;
		AvlTreeTime testTime100 = AvlTreeTime.create();
		AvlTreeTime.avlTreeTimeTest(leftarr100,testTime100);
